// Renders a single ayah: Arabic (RTL, exact mushaf glyphs when loaded) and an
// optional translation underneath. Kept visually calm, like a printed mushaf.
// Audio playback is added in a later phase.
...
export default function AyahCard({ ayah, showTranslation, glyphs, size = 'm' }) {
